...
By extracting the template logic, you can maintain the same functionality with backend logic in Ember.
...
```jsx title="react-ice-cream-button/index.jsx" showLineNumbers
