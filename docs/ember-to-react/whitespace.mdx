...
- HTML entities can also be used here `&nbsp;` (non-breaking space). However, if you use that syntax, try to stay consistent in the same file for using other entities for whitespace. https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/no-unescaped-entities.md
